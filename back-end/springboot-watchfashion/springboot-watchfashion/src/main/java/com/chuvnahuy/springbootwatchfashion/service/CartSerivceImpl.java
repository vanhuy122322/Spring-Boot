...
import com.chuvnahuy.springbootwatchfashion.repository.AddToCartRepo;
import com.chuvnahuy.springbootwatchfashion.repository.CheckoutRepo;
...
public class CartSerivceImpl implements CartService {
	...
	@Autowired
	ProductServiceImpl proServices;
