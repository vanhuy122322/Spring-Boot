...
class AppoWatch extends Component {
...
componentDidMount(){
ProductService.getFashionProduct().then((res) =>{
...
render() { var settings = {
  ...
  <header className="section-heading heading-line">
    <h4 className="title-section text-uppercase">Đồng hồ Eco-Drive</h4>
  ...
  <div className="card card-home-category">
    <div className="row no-gutters">
      <div className="col-md-3">
          ...
          <img src={`${process.env.PUBLIC_URL}/resources/images/banners/DHphaimanh-330x428.png`} className="sssss" />
