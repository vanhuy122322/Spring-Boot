...
class PinWatch extends Component {
    constructor(props){
        super(props)
    ...
    componentDidMount(){
    ProductService.getPinProduct().then((res) =>{
    ...
    render() { var settings = {
      ...
      <header className="section-heading heading-linesss">
        <h4 className="title-section text-uppercases">Đồng hồ Pin</h4>
      ...
      <div className="card card-home-category">
        <div className="row no-gutters">
          <div className="col-md-3">
              ...
              <img src="resources/images/banners/DHDocquyendesk-330x428.jpg" className="sssss" />
  ...
  <p className="item-rating-total">35</p>
</div>
  ...
  <p className="item-rating-total">50</p>
</div>
  ...
  <p className="item-rating-total">22</p>
</div>
