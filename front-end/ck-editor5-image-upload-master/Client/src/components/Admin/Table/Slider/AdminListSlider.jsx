...
export default class AdminListSlider extends Component {
    constructor(props) {
        super(props);
        this.state = {
          content: [],
      ...
      findAll(currentPage) {
        currentPage -= 1;
        AdminService.getAllSlider(currentPage, this.state.size)
      ...
      addProduct() {
        this.props.history.push("/admin/newslider");
      }
      editEmployee(id) {
        this.props.history.push(`/editslider/${id}`);
      }
      deleteBrand(id) {
       
        AdminService.deleteSlider(id).then((res) => {
          this.setState({
