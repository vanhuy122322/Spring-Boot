...
export default class AdminBrand extends Component {
    constructor(props) {
        super(props);
        this.state = {
          content: [],
      ...
      findAll(currentPage) {
        currentPage -= 1;
        AdminService.getAllBrand(currentPage, this.state.size)
          ...
          <div className="">
            <div className="card mb-12">
              <div className="card-header">
                ...
                >
                  <i class="fa fa-plus" aria-hidden="true"></i> Thêm mới(TH)
                </button>
              </div>
                    ...
                    {this.state.content.map((allbrand) => (
                      <tr>
                        ...
                        <a
                          ...
                          href={`/admin/detailbrand/${allbrand.id}`}
