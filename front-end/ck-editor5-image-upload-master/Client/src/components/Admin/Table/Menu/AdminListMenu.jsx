...
export default class AdminListMenu extends Component {
    constructor(props) {
        super(props);
        this.state = {
          content: [],
      ...
      findAll(currentPage) {
        currentPage -= 1;
        AdminService.getAllMenu(currentPage, this.state.size)
      ...
      addProduct() {
        this.props.history.push("/admin/newmenu");
      }
      editEmployee(id) {
      ...
      deleteBrand(id) {
        ...
        AdminService.deleteMenu(id).then((res) => {
          this.setState({
          ...
          <div className="">
            <div className="card mb-12">
              <div className="card-header">
                ...
                >
                  <i class="fa fa-plus" aria-hidden="true"></i> Thêm mới(MENU)
                </button>
              </div>
